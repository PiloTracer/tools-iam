...
providers: [
  KeycloakProvider({
    ...
    issuer: "http://localhost:8080/realms/codeiva-ecosystem",
  })
]
```
...
oauth2_scheme = OAuth2AuthorizationCodeBearer(
    authorizationUrl="http://localhost:8080/realms/codeiva-ecosystem/protocol/openid-connect/auth",
    tokenUrl="http://localhost:8080/realms/codeiva-ecosystem/protocol/openid-connect/token"
)
...
1.  Start your app.
2.  Click "Login".
3.  Redirect to Keycloak (`localhost:8080`).
